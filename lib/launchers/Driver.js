...
//		var files = [
//			__dirname + "/../../static/lib/jquery-1.8.3.min.js",
//			__dirname + "/../../static/lib/jasmine.min.js",
//			__dirname + "/../../static/lib/jasmine-html.min.js",
//			__dirname + "/../../static/lib/matcher.min.js",
//			__dirname + "/../../static/lib/simulate.min.js",
//			__dirname + "/../../static/lib/taobao.min.js"
//		];
//
//		var fileToString = '';
//
//		files.forEach(function (file) {
//			fileToString += (';' + fs.readFileSync(file, 'utf-8').toString());
//		});
		...
		self._process.stdout.on('data', function (data) {
			...
			self.session(function (sessionId) {
				self.url(sessionId, capturingUrl, function () {
