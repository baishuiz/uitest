...
Block.prototype.execute = function (onComplete) {
    ...
    if (host.func) {
        ...
        runner.browser.start(host.func, host.ready)
        runner.browser.once("complete", function (data) {
            ...
            if (data) {
                ...
                results.browser = runner.browser.fullName;
...
var execute = function (callback) {
    ...
    runners.forEach(function (currentRunner) {
        ...
        currentRunner.execute(function (currentRunner) {
            ...
            allResults[currentRunner.name] = currentRunner.results;


            if (env.configs.autoClose && currentRunner.browser){

                currentRunner.browser.close();
            }
