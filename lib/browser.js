...
Browser = function (name, url, timeout, emitter) {
    ...
    this.start = function (func, readyFunc) {
        ...
        var files = [
            "//localhost:8080/client/jquery-1.8.3.js",
            "//localhost:8080/client/jasmine-ui/jasmine.js",
            "//localhost:8080/client/jasmine-ui/jasmine-html.js",
            "//localhost:8080/client/jasmine-ui/matcher.js",
            "//localhost:8080/client/jasmine-ui/simulate.js",
            "//localhost:8080/client/jasmine-ui/taobao.js"
        ];
