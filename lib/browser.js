...
Browser = function (name, url, timeout) {
    ...
    this.start = function (func, readyFunc) {
        ...
        this.startBrowser(function () {
            ...
            func = host.wrapFunc(func, {username: 'xiaoju4', password: 'taobao1234'});
    ...
    this.wrapFunc = function (func, shareData) {
        ...
        var runScript = function () {
            ...
            var port = portRec[protocal] || 8080;
            var files = [
                "//localhost:" + port + "/client/jquery-1.8.3.js",
                "//localhost:" + port + "/client/jasmine-ui/jasmine.js",
                "//localhost:" + port + "/client/jasmine-ui/jasmine-html.js",
                "//localhost:" + port + "/client/jasmine-ui/matcher.js",
                "//localhost:" + port + "/client/jasmine-ui/simulate.js",
                "//localhost:" + port + "/client/jasmine-ui/taobao.js"
            ];
